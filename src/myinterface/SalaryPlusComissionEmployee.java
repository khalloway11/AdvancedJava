...
public class SalaryPlusComissionEmployee extends SalariedEmployee{
    ...
    public SalaryPlusComissionEmployee(String fname, String lname, double salary, double comission, int empID){
        super(fname, lname, salary, empID);
        this.comissionRate = (comission/100);
        this.totalSales = 0;
    }
    
    public SalaryPlusComissionEmployee(String fname, String lname, double salary, double comission, int empID, double sales){
        super(fname, lname, salary, empID);
        this.comissionRate = (comission/100);
